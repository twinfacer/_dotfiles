...
# Written and maintained by @twinfacer (https://github.com/twinfacer) 2021-2026 (C)
...
## 2) Generate ssh key-pair if necessary
_setup_ssh() {
...
arch_packages=(
  ...
  john-git thc-hydra metasploit-git hashcat-git sslyze sslscan testssl.sh nuclei nikto cmsscanner
  enum4linux netexec python-smbmap-git kerbrute-bin responder httpx
  ## Wireless toolz
  aircrack-ng airgeddon pixiewps
)
